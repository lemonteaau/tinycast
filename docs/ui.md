...
All seven palette lists (App Launcher, Clipboard, Emoji, File Search, Calculator History, Dictionary
History, Uninstall) render category labels through one shared **`SectionHeader`** (`.subheadline.medium`,
